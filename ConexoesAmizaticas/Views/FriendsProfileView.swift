...
struct FriendsProfileView: View {
    @State var inicialViewModel: InicialViewModel
    var viewModel : FriendProfileViewModel
    
    init(connection: Connection, inicialViewModel: InicialViewModel){
        self.inicialViewModel = inicialViewModel
    ...
    var body: some View {
        ZStack{
            ...
            VStack{
                ...
                NavigationLink(destination: BLEView(vm: $inicialViewModel, profile: viewModel.connection.friend)) {
                    ZStack{
                        HStack(spacing: -40){
...
#Preview {
    ...
    FriendsProfileView(connection: c, inicialViewModel: viewModel)
}
